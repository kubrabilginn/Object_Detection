...
from sklearn.neighbors import KNeighborsClassifier # KNN için yeni import
...
# Script'iniz ana staj_projesi/ dizininde değilse, yolu düzeltmeniz gerekebilir.
# Şimdilik script'in ana dizinde olduğunu varsayıyoruz.
DATA_PATH = os.path.join(PROJECT_ROOT, 'data', 'stanford_cars') 

# MAT Etiket Dosyası Yolu (cars_train_annos.mat)
MAT_FILE = os.path.join(DATA_PATH, 'car_devkit', 'devkit', 'cars_train_annos.mat')

# Görüntü Klasörleri (İç içe geçmiş yapıyı dahil ediyoruz)
...
def load_annotations(mat_file):
    ...
    for ann in annotations:
        ...
        image_path = ann['fname'][0] # Görüntü dosya adını alıyoruz
...
for ann in annotations:
    ...
    # Görüntü Arama (Train ve Test Klasörlerinde)
...
while neg_count < NEGATIVE_SAMPLES_COUNT:
    ...
    # Randint hatasını engellemek için kritik kontrol
...
# -----------------
# 5. KNN Modelini Eğitme
# -----------------
K_VALUE = 5 # Karşılaştırma için K=5 kullanıyoruz
print(f"KNN Modeli Eğitiliyor (K={K_VALUE} kullanılıyor)...")
